...
import (
	...
	"github.com/nicocha30/gvisor-ligolo/pkg/sentry/fdimport"
	"github.com/nicocha30/gvisor-ligolo/pkg/sentry/fsimpl/host"
	"github.com/nicocha30/gvisor-ligolo/pkg/sentry/fsimpl/user"
	...
	"github.com/nicocha30/gvisor-ligolo/pkg/sentry/socket/netfilter"
	...
	"github.com/nicocha30/gvisor-ligolo/pkg/tcpip/link/ethernet"
	"github.com/nicocha30/gvisor-ligolo/pkg/tcpip/link/loopback"
	...
	"github.com/nicocha30/gvisor-ligolo/runsc/boot/filter"
	_ "github.com/nicocha30/gvisor-ligolo/runsc/boot/platforms" // register all platforms.
	"github.com/nicocha30/gvisor-ligolo/runsc/boot/pprof"
	...
	"github.com/nicocha30/gvisor-ligolo/runsc/specutils/seccomp"

	// Top-level inet providers.
	"github.com/nicocha30/gvisor-ligolo/pkg/sentry/socket/hostinet"
	"github.com/nicocha30/gvisor-ligolo/pkg/sentry/socket/netstack"

	// Include other supported socket providers.
	_ "github.com/nicocha30/gvisor-ligolo/pkg/sentry/socket/netlink"
	_ "github.com/nicocha30/gvisor-ligolo/pkg/sentry/socket/netlink/route"
	_ "github.com/nicocha30/gvisor-ligolo/pkg/sentry/socket/netlink/uevent"
	_ "github.com/nicocha30/gvisor-ligolo/pkg/sentry/socket/unix"
)
